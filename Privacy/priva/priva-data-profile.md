...
Эта аналитика ссылается на сведения из функции сопоставления данных в запросах прав субъекта и отображает элементы содержимого, обнаруженные в Microsoft 365, которые содержат большинство субъектов данных. Дополнительные сведения об этом параметре см. в статье ["Запросы прав субъекта"](subject-rights-requests.md).
