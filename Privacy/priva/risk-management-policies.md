...
1. В [Центр соответствия требованиям Microsoft 365](https://compliance.microsoft.com/) перейдите в раздел Управление рисками конфиденциальности Привы и выберите **Политики**.
