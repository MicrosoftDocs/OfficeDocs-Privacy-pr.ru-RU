...
Создайте новые политики в службе "Управление рисками конфиденциальности" для устранения сценариев риска конфиденциальности, важных для вашей организации. Для быстрого запуска используйте шаблоны по умолчанию для создания новых политик для чрезмерного использования данных, передачи данных, минимизации данных и сценариев.

1. [Создание политики на основе шаблона](risk-management-policies.md#create-a-policy-from-a-template)
1. [Создание настраиваемой политики](risk-management-policies.md#create-a-custom-policy)
1. [Сведения о ключевых параметрах для всех политик](risk-management-policies.md#learn-about-key-settings-for-all-policies)
...
1. [Сведения о параметрах политик чрезмерного использования данных](risk-management-policies.md#learn-about-settings-for-data-overexposure-policies)
...
1. [Тестирование политики](risk-management-policies-manage.md#test-your-policy)
...
1. [Подготовка обучающего содержимого для уведомлений политики](risk-management-notifications.md#prepare-training-content-for-policy-notifications)
1. [Настройка уведомлений по электронной почте для политик](risk-management-notifications.md#set-up-email-notifications-for-policies)
1. [Устранение проблем с уведомлениями по электронной почте](risk-management-notifications.md#remediate-issues-from-email-notifications)
