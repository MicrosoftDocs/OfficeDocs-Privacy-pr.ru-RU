...
1. Выберите "Начать пробную версию", и для вас будет выполнено следующее:
    - Priva пробные лицензии включены (это происходит в режиме реального времени)
...
Для начала перейдите в раздел Priva [раздела Портал соответствия требованиям Microsoft Purview и](https://compliance.microsoft.com/) просмотрите следующие страницы:
...
С помощью сопоставления данных организации могут Priva определять субъекты данных на основе точных значений данных.
...
После создания запроса прав субъекта Priva будут использовать ваши входные данные о субъекте для поиска совпадений в среде Microsoft 365 организации. После компиляции этих данных вы можете просмотреть результаты, выбрать, что включить, и при необходимости отладить сведения.
...
1. [Создание нового потока Power Automate на основе шаблона](subject-rights-requests-automate.md#create-a-new-power-automate-flow-from-a-template)
...
**Почему Microsoft Priva**. Дополнительные сведения о Priva [в этом видео](https://www.youtube.com/watch?v=6OLky1biPIQ).
