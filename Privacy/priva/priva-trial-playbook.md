...
ms.locfileid: "66549258"
---
# <a name="trial-playbook-microsoft-priva"></a>Пробный сборник схем: Microsoft Priva

Добро пожаловать в сборник схем Microsoft Priva пробной версии.
...
Запустите пробную версию, настроив необходимые условия. Обратите внимание, что Priva состоит из двух ключевых решений, Управление рисками информационной безопасности Priva и Запросы субъектов данных Priva, которые можно опробовыть и приобрести отдельно. Сведения о лицензировании и приобретении можно [найти на Microsoft.com](https://www.microsoft.com/security/business/privacy/privacy-management-software?rtc=1#office-ContentAreaHeadingTemplate-8x0pmkp).

### <a name="privacy-risk-management"></a>Управление рисками конфиденциальности
...
## <a name="start-your-microsoft-priva-trial"></a>Запуск пробной Microsoft Priva версии

Если вы готовы приступить к использованию Microsoft Priva, выполните следующие действия, чтобы настроить предварительные требования и приступить к изучению аналитики конфиденциальности.

1. [Подтверждение подписок и лицензирования](priva-setup.md#confirm-subscriptions-and-licensing)
1. [Настройка разрешений пользователя и назначение ролей](priva-setup.md#set-user-permissions-and-assign-roles)
...
## <a name="start-finding-and-visualizing-privacy-risks"></a>Начало поиска и визуализации рисков конфиденциальности
...
Для начала перейдите в раздел Priva [Портал соответствия требованиям Microsoft Purview и](https://compliance.microsoft.com/) просмотрите следующие страницы:

1. [Обзор](priva-data-profile.md#explore-the-overview-page). Предоставляет обобщенное представление о состоянии конфиденциальности, включая объем, категорию, расположение и перемещение персональных данных в среде Microsoft 365. Кроме того, вы можете отслеживать текущее состояние и тенденции связанных рисков конфиденциальности, возникающих в результате чрезмерного использования, передачи или неиспользуемых персональных данных.
...
## <a name="create-and-customize-policies"></a>Создание и настройка политик
...
1. [Подготовка обучающего содержимого для уведомлений политики](risk-management-notifications.md#prepare-training-content-for-notifications)
...
Администраторы управления правами субъектов могут открывать новые запросы прав субъекта на главной странице "Запросы прав субъекта". Мастер поможет вам найти персональные данные о субъекте данных и начать процесс выполнения запроса.

1. [Использование мастера запроса прав субъекта](subject-rights-requests-create.md#custom-setup-guided-process-to-choose-all-settings) — создание запроса
1. [Определение параметров поиска](subject-rights-requests-create.md#defining-search-settings)
1. [Уточнение параметров поиска](subject-rights-requests-create.md#refining-your-search)
...
1. [Отправка персональных данных](subject-rights-requests-data-match.md#upload-personal-data)
...
После создания запроса прав субъекта Priva будет использовать ваши входные данные о субъекте для поиска совпадений в среде Microsoft 365 вашей организации. После компиляции этих данных вы можете просмотреть результаты, выбрать, что включить, и при необходимости отладить сведения.

1. [Просмотр сведений о запросе и отслеживание хода выполнения](subject-rights-requests-workflow.md)
1. [Просмотр и изменение поисковых запросов](subject-rights-requests-create.md#defining-search-settings)  (необязательно)
1. [Просмотр данных](subject-rights-requests-data-review.md)
1. [Закрытие запроса](subject-rights-requests-reports.md)
...
Включите потоки Power Automate для Priva, чтобы автоматизировать важные задачи для вариантов и пользователей, такие как создание билетов в ServiceNow или добавление напоминаний календаря о датах выполнения.

1. [Создание потока Power Automate на основе шаблона](subject-rights-requests-automate.md#create-a-new-power-automate-flow-from-a-template)
1. [Совместное использование потока Power Automate](subject-rights-requests-automate.md#share-a-power-automate-flow)
1. [Изменение или удаление потока Power Automate](subject-rights-requests-automate.md#edit-or-delete-power-automate-flow)

## <a name="additional-resources"></a>Дополнительные ресурсы

**Документация Майкрософт**. Получите подробные сведения о Microsoft Priva и о том, как лучше всего реализовать его для вашей организации. [Посетите документацию](priva-overview.md).
...
**Дополнительные сведения о Microsoft Priva** блогах, планах и ценах [см. здесь](https://aka.ms/privacymgmt/web).
