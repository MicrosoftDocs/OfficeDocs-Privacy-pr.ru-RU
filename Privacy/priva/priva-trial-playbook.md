...
## <a name="start-your-microsoft-priva-trial"></a>Запуск пробной пробной программы Microsoft Priva
...
![Захват экрана приветствуемого экрана.](../media/priva-insights.png)
...
## <a name="learn-about-policies"></a>Узнайте о политиках
...
![Захват экрана страницы основных политик.](../media/priva-policies-page.png)
