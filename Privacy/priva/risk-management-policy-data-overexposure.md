...
- MOE150
- MET150
description: Узнайте, как создать политику перегрузки данных в microsoft Priva Privacy Risk Management для идентификации и защиты персональных данных, которые могут быть чрезмерно доступными.
ms.openlocfilehash: a0c87a84a78206862d9a79e1c16d17a90de5f040
ms.sourcegitcommit: b5f7dcb73c0e3f677981e80106769cb546d00af4
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/21/2022
ms.locfileid: "65014509"
---
...
8. На странице **"** Условия" выберите тип условия перегрузки данных, которое будет обнаруживать политика:
    ...
    Установите флажок рядом с выбранными вариантами и нажмите кнопку **"Далее"**.
